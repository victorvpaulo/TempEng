...
def placeholder_for_compilation(static_file_path, output_path):
    print(static_file_path)
    print(output_path)


def placeholder_for_execution(template_path, context_path, execute_output_path):
    print(template_path)
    print(context_path)
...
parser.add_argument("-e", "--execute", default=False, action="store_true",
                    ...
                    " template. By default executes the template generated by"
                    "the compile action will be used. However, if the"
                    " --compile argument is not passed along with --execution"
...
parser.add_argument("-d", "--context", type=str, metavar="<file path>",
                    ...
                    " The context file provides the data to be pluged into the"
                    " template. Must be a json file.")
...
if args.execute:
    ...
    placeholder_for_execution(template_path, context_path, execute_output_path)
